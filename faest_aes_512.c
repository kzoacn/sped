...
#define bf_t bf512_t
#define bf_load bf512_load
#define bf_store bf512_store
#define bf_from_bit bf512_from_bit
#define bf_zero bf512_zero
#define bf_one bf512_one
#define bf_add bf512_add
#define bf_mul bf512_mul
#define bf_sum_poly bf512_sum_poly
#define bf_inv bf512_inv
#define zk_hash zk_hash_512 


static bf_t* column_to_row_major_and_shrink_V_512(uint8_t** v, unsigned int ell) {
...
static void aes_prove_512(const uint8_t* w, const uint8_t* u, uint8_t** V, const uint8_t* input,
  ...
  //double ck1=clock();
  // Step: 1..2
  bf_t* bf_v = column_to_row_major_and_shrink_V_512(V, l);
...
static uint8_t* aes_verify_512(const uint8_t* d, uint8_t** Q, const uint8_t* chall_2,
  ...
  // Step: 11..12
  bf_t* bf_q = column_to_row_major_and_shrink_V_512(Q, l);
