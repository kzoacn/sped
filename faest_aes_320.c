...
#define bf_t bf320_t
#define bf_load bf320_load
#define bf_store bf320_store
#define bf_from_bit bf320_from_bit
#define bf_zero bf320_zero
#define bf_one bf320_one
#define bf_add bf320_add
#define bf_mul bf320_mul
#define bf_sum_poly bf320_sum_poly
#define bf_inv bf320_inv
#define zk_hash zk_hash_320 


static bf_t* column_to_row_major_and_shrink_V_320(uint8_t** v, unsigned int ell) {
...
static void aes_prove_320(const uint8_t* w, const uint8_t* u, uint8_t** V, const uint8_t* input,
  ...
  //double ck1=clock();
  // Step: 1..2
  bf_t* bf_v = column_to_row_major_and_shrink_V_320(V, l);
...
static uint8_t* aes_verify_320(const uint8_t* d, uint8_t** Q, const uint8_t* chall_2,
  ...
  // Step: 11..12
  bf_t* bf_q = column_to_row_major_and_shrink_V_320(Q, l);
