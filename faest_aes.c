...
static bf_t* column_to_row_major_and_shrink_V(uint8_t** v, unsigned int ell) {
...
static void aes_prove_internal(const uint8_t* w, const uint8_t* u, uint8_t** V, const uint8_t* input,
  ...
  // Step: 1..2
  bf_t* bf_v = column_to_row_major_and_shrink_V(V, l);
...
static uint8_t* aes_verify_internal(const uint8_t* d, uint8_t** Q, const uint8_t* chall_2,
  ...
  // Step: 11..12
  bf_t* bf_q = column_to_row_major_and_shrink_V(Q, l);
...
void aes_prove(const uint8_t* w, const uint8_t* u, uint8_t** V, const uint8_t* in,
    ...
    aes_prove_internal(w, u, V, in, out, chall, a_tilde, b_tilde, params);
}
